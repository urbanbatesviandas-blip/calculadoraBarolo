...
import { 
  ...
  FileSpreadsheet, MonitorPlay, Layers, Building, Lock, Award, Percent, ShieldAlert, Search, X
} from 'lucide-react'
...
const formatARSWithDecimals = formatARS
        ...
        <div className={`${isAiDrawerOpen ? 'xl:col-span-5' : 'lg:col-span-5'} space-y-6`}>
          ...
          {isClientViewMode ? (
            <ClientViewInvestmentCard
              ...
              ticketAvgPrice={ticketAvgPrice}
              selectedIncomes={selectedIncomes}
              totalExtraIncomes={totalExtraIncomes}
              onOpenProposal={() => setIsProposalModalOpen(true)}
              onExportHtml={handleExportHtmlPresentation}
              formatARS={formatARS}
            />
          ) : (
            <div className="bg-white rounded-2xl shadow-luxury border border-slate-200 overflow-hidden">
